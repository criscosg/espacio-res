 ...
 * @ORM\DiscriminatorMap({"event"="ImageEvent"})
 */
abstract class Image
{
    const WEB_PATH = 'bundles/frontend/img/';
    const UPLOAD_PATH = '/var/www/res/web/uploads/';
    ...
    const DEFAULT_IMG = 'bundles/frontend/img/no-photo-space.png';
    const DEFAULT_IMG_W = 'bundles/frontend/img/no-photo-spacew.png';
    const DEFAULT_IMG_D = 'bundles/frontend/img/no-photo-spaced.png';
    ...
    /**
     * @ORM\OneToMany(targetEntity="Res\ImageBundle\Entity\ImageCopy", mappedBy="image", cascade={"persist", "merge", "remove"})
     */
    ...
    public function setImageEventBox(\Res\ImageBundle\Entity\ImageEventBox $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }

    public function getImageEventCarouselThumbnail()
    {
        return $this->getImageCopyFromType('ImageEventCarouselThumbnail');
    }

    public function setImageEventCarouselThumbnail(\Res\ImageBundle\Entity\ImageEventCarouselThumbnail $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }

    public function getImageEventCarousel()
    {
        return $this->getImageCopyFromType('ImageEventCarousel');
    }

    public function setImageEventCarousel(\Res\ImageBundle\Entity\ImageEventCarousel $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }
    ...
    public function setImageThumbnail(\Res\ImageBundle\Entity\ImageThumbnail $thumbnail)
    {
        $this->setUniqueImageCopy($thumbnail);
    }
    ...
    {
        $class = "Res\\ImageBundle\\Entity\\$type";
